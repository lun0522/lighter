...
#ifndef JESSIE_ENGINE_WRAPPER_VULKAN_BUFFER_H
#define JESSIE_ENGINE_WRAPPER_VULKAN_BUFFER_H

#include <memory>
#include <string>
#include <vector>

#include "jessie_engine/wrapper/vulkan/descriptor.h"
...
#endif /* JESSIE_ENGINE_WRAPPER_VULKAN_BUFFER_H */
